export default function initInputTaxRadio() {
  ...
  /*
    função anônima auto executada "(() => {})();", isso evita que as variaveis fiquem visiveis globalmente no console
    pq as variaveis serão declaradas no escopo da função anônima, isso evita a manipulação direta no console para não alterarem manualmente
    os valores das taxas usando o console
  */
